...
def main():
    ...
    training_stats_path = os.path.join(log_dir, "sac_training_stats.pkl")
    ...
    model.learn(total_timesteps=200_000, callback=[checkpoint_callback, eval_callback, stats_callback])
